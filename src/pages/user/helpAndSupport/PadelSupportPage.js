            ...
            <Row className="d-flex align-items-stretch">
              ...
              <Col lg={8} className="mb-4 d-flex">
                ...
                {activeSection === 'submit' && (
                  <Card className="shadow-sm w-100">
                    <Card.Body className="h-100">
                      <h5 id="contact-form" className='add_font_size_nav_logo'>Submit a request</h5>
                      <p className="text-muted add_font_small_mobile">Fill this form and our support team will contact you within 24 hours.</p>

                      {sent && <div className="alert alert-success add_font_small_mobile">Your request has been submitted. We'll reply to your email soon.</div>}

                      <Form onSubmit={handleSubmit} noValidate>
                        <Row>
                          <Col md={6}>
                            <Form.Group className="mb-3">
                              <Form.Label className="add_font_small_mobile">Name</Form.Label>
                              <Form.Control
                                value={form.name}
                          ...
                          <Col md={6}>
                            <Form.Group className="mb-3">
                              <Form.Label className="add_font_small_mobile">Email</Form.Label>
                              <Form.Control
                                value={form.email}
                        ...
                        <Form.Group className="mb-3">
                          <Form.Label className="add_font_small_mobile">Subject</Form.Label>
                          <Form.Control
                            value={form.subject}
                        ...
                        <Form.Group className="mb-3">
                          <Form.Label className="add_font_small_mobile">Message</Form.Label>
                          <Form.Control
                            as="textarea"
                            rows={5}
                            value={form.message}
            ...
            <Row className="mt-4">
              <Col lg={12} className="mb-4">
                <Card className="shadow-sm">
                  <Card.Body>
                    <h5 className='add_font_size_nav_logo'>Contact options</h5>
                    <p className="mb-1 add_font_small_mobile"><strong>Email:</strong> {ownerId?.email}</p>
                    <p className="mb-1 add_font_small_mobile"><strong>Phone:</strong> {ownerId?.countryCode} {ownerId?.phoneNumber}</p>
                    <p className="mb-3 add_font_small_mobile text-muted">Available Mon–Sat, 9:00–18:00</p>
