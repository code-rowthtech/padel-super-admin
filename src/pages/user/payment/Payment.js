...
const Payment = ({ className = "" }) => {
  ...
  const totalAmount = courtData?.time?.reduce(
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const slotArray = selectedTimeArray.map((timeSlot) => {
        ...
        const matchingSlot = slotTimesData.find(
      ...
      <div className="row w-100">
        <div className="col-7">
          <div className="bg-white rounded">
            {/* Info Section */}
            <div
              className="rounded-4 py-4 px-5 mb-4"
        ...
        <div className="col-5">
          <div
            className="border rounded px-3 py-5 border-0"
            ...
            >
              {selectedCourts?.map((court, index) => (
                <>
                  ...
                  <div
                    key={index}
                    className="court-row d-flex justify-content-between align-items-center mb-3 "
                  >
                    <div>
            ...
            <div className="d-flex justify-content-center mt-3">
              <button
                style={{
                  ...
                  cursor:
                    isFormValid && selectedCourts.length > 0
                      ? "pointer"
                      : "not-allowed",
                }}
                ...
                className={className}
                disabled={
                  !isFormValid || isLoading || selectedCourts.length === 0
                }
              >
                <svg
                  style={svgStyle}
                ...
                >
                  ...
                  <path
                    d={`M ${width * 0.76} ${height * 0.15} 
                        C ${width * 0.79} ${height * 0.15} ${width * 0.81} ${
                      height * 0.2
                      ...
                      height * 0.32
                    } ${width * 0.86} ${height * 0.3} 
                        C ${width * 0.88} ${height * 0.2} ${width * 0.9} ${
                      height * 0.15
                    } ${width * 0.92} ${height * 0.15} 
                        C ${width * 0.97} ${height * 0.15} ${width * 0.996} ${
                      height * 0.3
                    } ${width * 0.996} ${height * 0.5} 
                        C ${width * 0.996} ${height * 0.7} ${width * 0.97} ${
                      height * 0.85
                    } ${width * 0.92} ${height * 0.85} 
                        C ${width * 0.9} ${height * 0.85} ${width * 0.88} ${
                      height * 0.8
