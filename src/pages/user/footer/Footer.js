...
const Footer = () => {
  return (
    <footer className="bg-light py-md-5 py-4" style={{ borderTop: '1px solid #dee2e6' }}>
      <Container>
        <Row className="justify-content-between align-items-center">
          ...
          <Col md={4} className="text-lg-end text-start">
            ...
            <div className="d-flex  flex-sm-row justify-content-md-end justify-content-center gap-3 small text-muted">
              {/* Bottom Links */}
              <a href="/privacy-policy" className="text-decoration-none address_data">Privacy Policy</a>
              <a href="/manage-cookies" className="text-decoration-none address_data">Manage Cookies</a>
              <a href="/sitemap" className="text-decoration-none address_data">Sitemap</a>
