...
const MatchPlayer = ({
  ...
  return (
    <>
      <div
        className="py-md-3 pt-0 pb-3 rounded-3 px-md-4 px-2 bgchangemobile"
      ...
      >
        ...
        >
          ...
          <div className="row text-center border-top">
            <div className="col py-2">
              <p
                className="mb-md-1 mb-0 add_font_mobile "
                style={{
                  fontSize: "13px",
                  fontWeight: "500",
                  fontFamily: "Poppins",
              ...
              <p
                className="mb-0 add_font_mobile_bottom"
                style={{
                  fontSize: "15px",
                  fontWeight: "500",
                  fontFamily: "Poppins",
            ...
            <div className="col border-start border-end py-2">
              <p
                className="mb-1 add_font_mobile  "
                style={{
                  fontSize: "13px",
                  fontWeight: "500",
                  fontFamily: "Poppins",
        ...
        {/* Players Section */}
        <div
          className="p-md-3 p-2 rounded-3 mb-2"
          style={{
            backgroundColor: "#CBD6FF1A",
            border: "1px solid #ddd6d6ff",
          }}
        >
                ...
                <div className="d-flex flex-column align-items-center me-auto mb-3">
                  <div
                    ...
                    style={{
                      width: 68,
                      height: 68,
                      backgroundColor: localPlayers.slot2.profilePic
                        ? "transparent"
                        : "#3DBE64",
                      overflow: "hidden",
                    }}
                  >
                    {localPlayers.slot2.profilePic ? (
                      <img
                        src={localPlayers.slot2.profilePic}
                        alt=""
                        style={{
                          width: "100%",
                          height: "100%",
                  ...
                  >
                    {localPlayers.slot2.name?.length > 12
                      ? `${localPlayers.slot2.name.substring(0, 12)}...`
                      : localPlayers.slot2.name}
                  </p>
                  <Tooltip id="you" />
                  <span
                    className="badge text-white"
                ...
                <div className="d-flex flex-column align-items-center ms-auto mb-3">
                  <div
                    ...
                    style={{
                      width: 68,
                      height: 68,
                      backgroundColor: localPlayers.slot3.profilePic
                        ? "transparent"
                        : "#1F41BB",
                      overflow: "hidden",
                    }}
                  >
                    {localPlayers.slot3.profilePic ? (
                      <img
                        src={localPlayers.slot3.profilePic}
                        alt=""
                        style={{
                          width: "100%",
                          height: "100%",
                  ...
                  >
                    {localPlayers.slot3.name?.length > 12
                      ? `${localPlayers.slot3.name.substring(0, 12)}...`
                      : localPlayers.slot3.name}
                  </p>
                  <Tooltip id="you" />
                  <span
                    className="badge text-white"
                ...
                <div className="d-flex flex-column align-items-center ms-auto mb-3">
                  <div
                    ...
                    style={{
                      width: 68,
                      height: 68,
                      backgroundColor: localPlayers.slot4.profilePic
                        ? "transparent"
                        : "#1F41BB",
                      overflow: "hidden",
                    }}
                  >
                    {localPlayers.slot4.profilePic ? (
                      <img
                        src={localPlayers.slot4.profilePic}
                        alt=""
                        style={{
                          width: "100%",
                          height: "100%",
                  ...
                  >
                    {localPlayers.slot4.name?.length > 12
                      ? `${localPlayers.slot4.name.substring(0, 12)}...`
                      : localPlayers.slot4.name}
                  </p>
                  <Tooltip id="you" />
                  <span
                    className="badge text-white"
