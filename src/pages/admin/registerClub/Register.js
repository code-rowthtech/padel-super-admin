        ...
        <Row className="align-items-center justify-content-center g-5 position-relative">
          <Col lg={7} md={12} className="position-relative z-1">
            <div className="pe-lg-4">
              ...
              <h3 className="fw-semibold mb-4">Owners!</h3>
              <p className="text-muted fs-6 mb-4">
                Bring your court online and connect with thousands of padel
                players through our app. <br />
                We make it simple to manage bookings, increase visibility, and
                grow your <br /> business – all in one place.
              </p>
                ...
                <li className="mb-3 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <small className="text-muted fw-medium">
                      Let players book your court instantly
                    </small>
                  </div>
                </li>
                <li className="mb-3 d-flex align-items-start">
                  ...
                  <div>
                    ...
                    <small className="text-muted fw-medium">
                      Fill empty slots, promote offers, and track earnings
                    </small>
                  </div>
                </li>
                <li className="mb-3 d-flex align-items-start">
              ...
              <p className="text-muted mb-4 small">
                Join our network of padel court owners and make your facility
                the go-to place for <br /> players in your city.
              </p>
