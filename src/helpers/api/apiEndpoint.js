...
export const CREATE_SLOT_PRICE = "/api/price/prices";
export const UPDATE_SLOT_BULK_PRICE = "/api/price/prices/bulk/update";
...
export const GET_CANCELLATION_BOOKING_DASHBOARD = "/api/super-admin/club-dashboard-cancellations";
export const GET_RECENT_BOOKING_DASHBOARD = "/api/super-admin/club-dashboard-current-bookings";
