...
const clubSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getUserSlotPrice.pending, (state) => {
      state.slotPriceLoading = true;
      state.slotPriceError = null;
    });
    builder.addCase(getUserSlotPrice.fulfilled, (state, action) => {
      state.slotPriceLoading = false;
      state.slotPriceData = action.payload;
    });
    builder.addCase(getUserSlotPrice.rejected, (state, action) => {
      state.slotPriceLoading = false;
