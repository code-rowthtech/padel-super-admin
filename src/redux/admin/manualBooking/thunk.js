...
export const getActiveCourts = createAsyncThunk(
    ...
    async (params, { rejectWithValue }) => { // Removed unused 'data' parameter
        try {
            const res = await getApi(`${Url.GET_ACTIVE_COURTS}?register_club_id=${params?.register_club_id}&day=${params?.day}`);
